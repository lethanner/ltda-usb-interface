...
#define USBD_VID 7778
#define USBD_LANGID_STRING 1033
#define USBD_MANUFACTURER_STRING     	"lethTech Diversity Audio"
#define USBD_PID_FS 4321
#define USBD_PRODUCT_STRING_FS			"LTDA Prime"
#define USBD_CONFIGURATION_STRING_FS	"LTDA Config"
#define USBD_INTERFACE_STRING_FS		"LTDA Interface"
...
USBD_DescriptorsTypeDef FS_Desc = { USBD_FS_DeviceDescriptor,
		...
		USBD_FS_ProductStrDescriptor, USBD_FS_SerialStrDescriptor,
